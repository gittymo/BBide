...
/** The TXA class is used to create objects representing the TXA assembler mnemonic in
 * BBide programs.  The purpose of this mnemonic is to transfer the contents of the
 * X register to the (A)ccumulator.  The (Z)ero flag is set if the accumulator is loaded
...
public class TXA extends OpCode {
	...
	public void perform(Memory memory) throws InvalidAddressModeException, InvalidAddressException, MemoryMissingException {
		...
		memory.registers.replace("A", memory.registers.get("X"));
