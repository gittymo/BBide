...
public class SBC extends com.plus.mevanspn.bbide.bridge.Processor.OpCode {
	@Override
	public int[] getASM() {
		switch (addressMode) {
	...
	public void perform(Memory memory)
					throws InvalidAddressException, InvalidAddressModeException, MemoryMissingException, InvalidValueException
	{
